...
export interface ApiChurchChurch extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Churches and religious organizations';
    displayName: 'Church';
    pluralName: 'churches';
    singularName: 'church';
  };
  ...
  attributes: {
    ...
    membershipCount: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    publishedAt: Schema.Attribute.DateTime;
    serviceTimes: Schema.Attribute.JSON;
...
export interface ApiSpeakerSpeaker extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Speakers including pastors and other church speakers';
    displayName: 'Speaker';
    pluralName: 'speakers';
  ...
  attributes: {
    ...
    socialMedia: Schema.Attribute.JSON;
    sortOrder: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    speakingTopics: Schema.Attribute.Component<'default.topic', true>;
